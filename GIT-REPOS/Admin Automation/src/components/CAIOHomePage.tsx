    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Free AI Solutions for Everyone</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Professional-grade solutions built by Your CAIO, just launched and available free to help you explore AI possibilities
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {tools.map((tool) => {
            ...
            return (
              <div key={tool.id} className="relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group border border-gray-100">
                <div className="absolute top-4 right-4 flex gap-2">
                  ...
                  {tool.comingSoon && (
                    <div className="bg-slate-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
                      Coming Soon
                    </div>
                  )}
                </div>
                ...
                <div className="p-8">
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${colorClasses[tool.color]} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-6 rounded-lg font-semibold transition-all flex items-center justify-center space-x-2 ${
                      tool.comingSoon 
                        ...
                        : `bg-gradient-to-r ${colorClasses[tool.color]} text-white hover:shadow-lg transform hover:scale-105`
                    }`}
                  >
                    <span>{tool.comingSoon ? 'Coming Soon' : 'Use Free Tool'}</span>
                    {!tool.comingSoon && <ArrowRight className="h-4 w-4" />}
                  </button>
                </div>
              </div>
            );
